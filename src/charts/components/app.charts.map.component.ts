/* This is a component ( Dumb component ) 
  ...
  */
  ...
  @Component({
      selector:'map-chart-component', // Selector is used on the pages to display what ever is in the template
      template: `
        <div>
            <div id="mapChartdiv" [style.width.%]="89" [style.height.px]="500"></div>
        </div>
  ...
  export class MapChartComponent { // Export the component
    ...
    const map = this.AmCharts.makeChart( "mapChartdiv", {
    "type": "map",
    "theme": "light",
    "dataProvider": {
        "map": "worldLow",
